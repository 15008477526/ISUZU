...
class AinasciiA2bHex():
    ...
    def terminal_vehicle_upload_realtime(self,vin,Longitude,Latitude,mileage):
        ...
        # 实时02数据
        binascii_data = ''  # 带有故障码
    ...
    def terminal_vehicle_upload_realtime_flameout(self,vin,Longitude,Latitude,mileage):
        ...
        # 实时02数据
        binascii_data = ''  # 带有故障码
        # binascii_data = ''  # 带有故障码 发动机转速大于200 ，车速0
        # binascii_data = '' # 不带有故障码
    ...
    def terminal_vehicle_report_incident(self, vin, Longitude, Latitude):
        ...
        # 报警事件报文
        # binascii_data = '2323C1FE4C45544145454733584B4839323130303301003D14031E0B1F2601520514031E0B1F260006E5ACCB01B4D2B7C514031E0B1F26001C9C4119000080000000000000000000000000000000000000FF00CA0018'
        # binascii_data = '2323C1FE4C45544145454733584B4839323130303301003D14031E0B1F2601520514031E0B1F260006E5ACCB01B4D2B7C514031E0B1F26001C9C41190102004018000000000000000000000000000000000000000018'
        binascii_data = '2323C1FE4C45544145454733584B4839323130303301003D14031E0B1F2601520514031E0B1F260006E5ACCB01B4D2B7C514031E0B1F26001C9C4119000000C600000018000000000AF000C00000000000000008010E'
    ...
    def terminal_vehicle_realtime_info_end(self, vin):
        ...
        binascii_data = ''
        # binascii_data = '2323C5FE4C45545945454732334C48303134333039010051004F140616111E2D271102000127120155271302000027140F0000000000000000000000000000002715060000000000002716020043271701012718040000001E27190400000510271A0102272102015015'

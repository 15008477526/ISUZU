...
class AinasciiA2bHex():
    ...
    def terminal_vehicle_upload_realtime(self,vin,Longitude,Latitude,mileage):
        ...
        binascii_data = ''
    ...
    def terminal_vehicle_upload_realtime_flameout(self,vin,Longitude,Latitude,mileage):
        ...
        binascii_data = ''
    ...
    def terminal_vehicle_report_incident(self, vin,Longitude,Latitude,mileage,mileage_end):
        ...
        # 驾驶行为报文
        binascii_data = '2323C2FE4A4C46303030303030303030303030303901003D1401130B0B1E1401190B1A32000007D0063500A201D3EE581401190B1F3200007D600633EB9201D394560078000500080007000600050004000300020291'
...
if __name__ == '__main__':
    ...
    for i in range(len(vin)):
        ...
        print("发送车辆熄火")
        tcpCliSock.send(lib.terminal_vehicle_upload_realtime_flameout(vin[i],Longitude[x],Latitude[x],mileage_end))
        time.sleep(0.5)
        print("发送车辆退出登录")

...
class AinasciiA2bHex():
    ...
    def terminal_vehicle_login(self,vin):
        ...
        binascii_data = '232301FE4C4554454444453130454830303030303201001C1401150F282000013839383631313138323930303331393636373337B2'
        ...
        # binascii_data = '232301FE4C4554454444453130454830303030303201001C1401150F282000013839383630333139333632303039323832323132B2'
        ...
        # now_time = (year + '05' + '1F' + '14' + '2B' + '24').upper()
        # print now_time
    ...
    def terminal_vehicle_upload_realtime(self,vin,Longitude,Latitude,mileage):
        ...
        # now_time_1 = (year + '05' + '1F' + '14' + '2B' + '24').upper()

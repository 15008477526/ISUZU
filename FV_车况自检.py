...
class AinasciiA2bHex():
    ...
    def terminal_vehicle_upload_realtime(self,vin,Longitude,Latitude,mileage):
        ...
        # 实时02数据
        binascii_data = ''  # 带有故障码
    ...
    def terminal_vehicle_report_incident(self, vin):
        '''发送车辆事件上报、车况自检和诊断数据：请求参数：车辆vin码、gateway地址、gateway端口'''

        #  车况自检报文
        # binascii_data = '2323C0FE4C45544544444531304548303030303032010012140115120612010E0002511B1209511B130145'
        # binascii_data = '2323C0FE4C45544544444531304548303030303032010012140115120612010E00020647F009C10F290145'
        # binascii_data = '2323C0FE49535554455354323538343039333136370100241401110D310403030002C29D8709C1008701090001940004010E000224AEF30905EB000140'  # 翼放EC
        # binascii_data = '2323C0FE49535554455354323538343039333136370100241401110D31040303000224AEF0090562A201090001920A13010E0002513721095110040140'  # 翼放EC
        # binascii_data = '2323C0FE49535554455354323538343039333136370100241401110D310403030002206A1209203F0001090001E20D00010E0002511F1209C075880140'  # 翼放ES
        binascii_data = '2323C0FE49535554455354323538343039333136370100241401110D310403030002921B380992270001090001911716010E0002E20D000951A7000140'  # 翼放ES
